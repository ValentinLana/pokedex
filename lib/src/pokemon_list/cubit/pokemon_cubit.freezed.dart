...
mixin _$PokemonState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            List<Pokemon> filteredPokemonList, List<Pokemon> pokemonList)
        loaded,
...
abstract class _$$_LoadedCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Pokemon> filteredPokemonList, List<Pokemon> pokemonList});
}
...
class _$_Loaded implements _Loaded {
  ...
  @override
  String toString() {
    return 'PokemonState.loaded(filteredPokemonList: $filteredPokemonList, pokemonList: $pokemonList)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(filteredPokemonList, pokemonList);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(filteredPokemonList, pokemonList);
  }
...
abstract class _Loaded implements PokemonState {
  const factory _Loaded(
      {required final List<Pokemon> filteredPokemonList,
      required final List<Pokemon> pokemonList}) = _$_Loaded;
...
class _$_Error implements _Error {
  ...
  @override
  String toString() {
    return 'PokemonState.error(detail: $detail)';
  }
